...
En un ejercio de mallas de corte en direccion alternada
con celdas fantasmas, Alice
programa un codigoe en el que si tieene arirba, abajo,
izquierda y derecha, va a hace runa recpcion no bloqueante de 
una subimagen (con menjo de indices) y luego va a enviar su 
subimagen .


Que priblema de mieen euvre y de rendimiento podria tener esa solucion y cual
seria la solucion ?
